...
class Graph {
    ...
    public void solve() {
        ...
        obj.println("NO");
        obj.println(this.components.get(1).get(0) + " " + this.components.get(0).get(0));
    }
    ...
    private void iterativeDFS(int vertex, boolean visited[], List<List<Integer>> adj, List<Integer> output) {
    ...
    private void stronglyConnectedComponents() {
        ...
        // int[] roots = new int[this.numVertices + 1]; // gives the root vertex of a
        // vertex's SCC
        boolean[] visited = new boolean[this.numVertices + 1];
        // Arrays.fill(roots, 0);
        Arrays.fill(visited, false);
